...
public class OrdersController {
    ...
    public R page(@RequestParam Map<String, Object> params,OrdersEntity orders,
		...
		if(tableName.equals("siji")) {
			orders.setSijigonghao((String)request.getSession().getAttribute("username"));
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("siji")) {
			wrapper.eq("sijigonghao", (String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("siji")) {
            ew.eq("sijigonghao", (String)request.getSession().getAttribute("username"));
		}
