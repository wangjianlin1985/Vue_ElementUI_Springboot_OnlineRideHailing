...
public class ChengkeController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ChengkeEntity user = chengkeService.selectOne(new EntityWrapper<ChengkeEntity>().eq("chengkezhanghao", username));
    ...
    public R register(@RequestBody ChengkeEntity chengke){
    	...
    	ChengkeEntity user = chengkeService.selectOne(new EntityWrapper<ChengkeEntity>().eq("chengkezhanghao", chengke.getChengkezhanghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ChengkeEntity chengke,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ChengkeEntity chengke, 
		HttpServletRequest request){
        EntityWrapper<ChengkeEntity> ew = new EntityWrapper<ChengkeEntity>();
		PageUtils page = chengkeService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, chengke), params), params));
        return R.ok().put("data", page);
