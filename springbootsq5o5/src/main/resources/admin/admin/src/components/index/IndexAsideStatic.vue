  ...
  <el-aside class="index-aside" width="150px">
    <div class="index-aside-inner menulist">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item">
		...
		<el-menu :mode="2 == 1? 'horizontal':'vertical'" :unique-opened="false" class="el-menu-demo" default-active="0">
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: #fff url("http://codegen.caihongy.cn/20211124/dfa7fdecbaeb4c80b6c04ee75c13047a.png") repeat top !important;
		...
		&>.el-menu-item {
			...
			background-color: rgba(245, 182, 27, 1) !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
				...
				background-color: rgba(245, 182, 27, 0) !important;
