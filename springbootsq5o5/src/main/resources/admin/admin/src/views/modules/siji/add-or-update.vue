<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="司机工号" prop="sijigonghao">
          <el-input v-model="ruleForm.sijigonghao" 
              placeholder="司机工号" clearable  :readonly="ro.sijigonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="司机工号" prop="sijigonghao">
              <el-input v-model="ruleForm.sijigonghao" 
                placeholder="司机工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='sijigonghao'){
            this.ruleForm.sijigonghao = obj[o];
	    this.ro.sijigonghao = true;
            continue;
          }
          if(o=='mima'){
