<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="乘客账号" prop="chengkezhanghao">
          <el-input v-model="ruleForm.chengkezhanghao" 
              placeholder="乘客账号" clearable  :readonly="ro.chengkezhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="乘客账号" prop="chengkezhanghao">
              <el-input v-model="ruleForm.chengkezhanghao" 
                placeholder="乘客账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="乘客姓名" prop="chengkexingming">
          <el-input v-model="ruleForm.chengkexingming" 
              placeholder="乘客姓名" clearable  :readonly="ro.chengkexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="乘客姓名" prop="chengkexingming">
              <el-input v-model="ruleForm.chengkexingming" 
                placeholder="乘客姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	chengkezhanghao : false,
	chengkexingming : false,
	touxiang : false,
	mima : false,
	xingbie : false,
	shoujihao : false,
	money : false,
      ...
      rules: {
          chengkezhanghao: [
                { required: true, message: '乘客账号不能为空', trigger: 'blur' },
          ],
          chengkexingming: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='chengkezhanghao'){
            this.ruleForm.chengkezhanghao = obj[o];
	    this.ro.chengkezhanghao = true;
            continue;
          }
          if(o=='chengkexingming'){
            this.ruleForm.chengkexingming = obj[o];
	    this.ro.chengkexingming = true;
            continue;
          }
          if(o=='touxiang'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chengke/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chengkeCrossAddOrUpdateFlag = false;
						 this.parent.search();
